...
class Editor {
    ...
    this.editor = new EditorJS({
      ...
      tools: {
        ...
        textColor: {
          ...
          config: {
            colorCollections: ["#000000", "#003366", "#806000", "#804000", "#660000", "#006600", "#330066", "#800040", "#663300", "#808080", "#0066FF", "#CC9900", "#E67300", "#990000", "#00FF00", "#6600FF", "#E60066", "#662200", "#A6A6A6", "#3385FF", "#FFB300", "#FF8000", "#CC0000", "#33FF33", "#8533FF", "#FF1A80", "#85331A", "#BFBFBF", "#66A3FF", "#FFD633", "#FF9933", "#FF0000", "#66FF66", "#A366FF", "#FF4D99", "#A3664D", "#D9D9D9", "#99C2FF", "#FFEB66", "#FFB366", "#FF3333", "#99FF99", "#C299FF", "#FF80B3", "#C29980", "#F2F2F2", "#CCE0FF", "#FFF299", "#FFD699", "#FF6666", "#CCFFCC", "#E0CCFF", "#FFB3CC", "#E0CCB3", "#FFFFFF", "#E6F2FF", "#FFF7CC", "#FFE6CC", "#FF9999", "#E6FFE6", "#F2E6FF", "#FFD9E6", "#F2E6D9", "#FF0000", "#FF6600", "#FFFF00", "#99CC00", "#33CC33", "#00CC99", "#0066CC", "#0000FF", "#660099"],
            type: 'text'
          }
        },
        indentTune: {
  ...
  save() {
    ...
    return _asyncToGenerator(function* () {
      var data = yield _this.editor.save();

      // Sanitizar cada bloco de texto antes de salvar
      data.blocks = data.blocks.map(block => {
        if (block.type === "paragraph" || block.type === "list") {
          block.data.text = _this.cleanHtml(block.data.text);
        }
        return block;
      });
      return data;
  ...
  saveHtml() {
    var _this2 = this;
    return _asyncToGenerator(function* () {
      var data = yield _this2.save();
      var htmlOutput = _this2.htmlParser.parse(data);
  ...
  cleanHtml(inputHtml) {
    var sanitized = DOMPurify.sanitize(inputHtml, {
